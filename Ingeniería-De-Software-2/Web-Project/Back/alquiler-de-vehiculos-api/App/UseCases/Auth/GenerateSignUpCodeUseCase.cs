...
{
    public class GenerateSignUpCodeUseCase
    {
        ...
        public GenerateSignUpCodeUseCase(IVerifyCodeRepository verifyCodeRepository, IEmailQueueRepository emailQueueRepository, ConvertInEmailTemplateUseCase convertInEmailTemplateUseCase)
        {
        ...
        {
            string code = _verifyCodeRepository.Generate(email, VerifyCodeType.SignUp);
