...
import styles from "./revenueStatistics.module.scss";
...
import RevenueStatsForm from "@/components/forms/revenueStatsForm/RevenueStatsForm";
import {
    BarChart,
    Bar,
    XAxis,
        ...
        <div className={styles.mainContainer}>
            ...
            {hasSearched ? (
                dataPerDay.length > 0 ? (
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart data={dataPerDay}>
                                ...
                                <YAxis
                                    allowDecimals={false}
                                    label={{
                                        value: "Ingresos en $", // ← texto del eje Y
                    ...
                    <p>No se encontraron ingresos en el rango de fechas</p>
                )
            ) : null}
        </div>
    );
