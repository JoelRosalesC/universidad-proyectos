"use client";
import styles from "./rentalWithReservation.module.scss";
import { poppins } from "@/lib/fonts/fonts";
import CreateRentalWithReservationForm from "@/components/forms/createRentalWithReservationForm/CreateRentalWithReservationForm";
import { useProtectedRoute } from "@/lib/customHooks/useProtectedRoute";
import { useEffect, useState } from "react";

export default function RentalWithReservation() {
    ...
    return (
        <div className={styles.mainContainer}>
            <h1 className={`${styles.title} ${poppins.className} `}>
                Realizando Alquiler con reserva
            </h1>

            <CreateRentalWithReservationForm reservations={reservations} />
        </div>
    );
}
