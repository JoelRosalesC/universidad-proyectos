...
import styles from "./revenueStatsForm.module.scss";
import BaseForm from "@/components/forms/baseForm/BaseForm";
import Check from "@/lib/svg/Check";
import { useAuth } from "@/context/AuthContext";
import { submitRevenueStatsForm } from "@/lib/submitActions/submitRevenueStatsForm";

export default function RevenueStatsForm({
    setDataPerDay,
    setRentals,
    setHasSearched,
}) {
    ...
    const customSubmitAction = async (prevState, formData) => {
        ...
        return await submitRevenueStatsForm(prevState, formData);
    };
