...
import { submitUpdateVehicleForm } from "@/lib/submitActions/submitUpdateVehicleForm";
import BaseForm from "@/components/forms/baseForm/BaseForm";
import SimpleInput from "@/components/inputs/SimpleInput";
import styles from "./updateVehicleForm.module.scss";
import { toast } from "sonner";
import SelectInput from "@/components/inputs/SelectInput/SelectInput";
import { useRouter } from "next/navigation";

export default function UpdateVehicleForm({ vehicle }) {
    const customSubmitAction = async (prevState, formData) => {
        const token = localStorage.getItem("token");
        if (token) formData.append("token", token);
        return await submitUpdateVehicleForm(prevState, formData);
    };
    ...
    return (
        ...
        >
            ...
            <SimpleInput
                ...
                required
                defaultValue={
                    state?.inputs?.licensePlate ?? vehicle?.licensePlate
                }
            ...
            <SimpleInput
                ...
                type={"text"}
                required
                defaultValue={state?.inputs?.color ?? vehicle?.color}
            ...
            <SimpleInput
                ...
                type={"text"}
                required
                defaultValue={state?.inputs?.year ?? vehicle?.year}
            ...
            <SelectInput
                ...
                defaultSelectedOption={
                    state?.inputs?.currentBranchId ?? vehicle?.currentBranchId
                }
            ...
            <SelectInput
                ...
                required
                defaultSelectedOption={
                    state?.inputs?.vehicleTypeId ?? vehicle.vehicleTypeId
                }
